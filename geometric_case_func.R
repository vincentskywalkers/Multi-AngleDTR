...
Ctfunc <- function(mt,N){
  C = sample(c(mt,3),N,replace = T,prob=c(5,3,1,1,1,1))
  #C = sample(c(mt,3),N,replace = T,prob=c(1,1,1,0.5,0.5,0.5))
  #C = sample(c(mt,3),N,replace = T,prob=c(3,2,1,1,1,1))
  return(C)
}
...
trainfunc <- function(N){
  ...
  for (Tt in 1:M){
    for (i in 1:N){
      cluster = sample( c(1,2,3),size = 1, prob=c(0.65,0.2,0.15))
      if (cluster == 1){
        XX= mvrnorm(n = 1, 1*Tt*c1, 1*diag(dimco))
      }
      if (cluster == 2){
        XX= mvrnorm(n = 1,  1*Tt*c2, 1*diag(dimco))
      }
      if (cluster == 3){
        XX= mvrnorm(n = 1,  1*Tt*c3, 1*diag(dimco))
      }
      d[i,Tt]=cluster
      X[i,Tt,] = XX
      A[i,Tt]=sample(x=c(1,2,3),1,replace = T,prob = c(1/3,1/3,1/3))
    }
  }
  
  datainfo = list(X=X,d=d,A=A)
  return(datainfo)
...
Tffunc <- function(N,M,A,d,X){
  ...
  Tf = c()
  for (i in 1:N){
    Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.85-0.02*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
      I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.5-0.025*I((X[i,1,5])^3 > 0),0.25+0.025*I((X[i,1,5])^3 <= 0),0.05,0.15,0.05))
    for (ttt in 2:(M-2)){
      Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.85-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
        I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.5-0.025*I((X[i,ttt,5])^3 > 0),0.25+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
      Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
    }
    for (ttt in (M-1):(M)){
      Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.85-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
        I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.5-0.025*I((X[i,ttt,5])^3 > 0),0.25+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
...
#   Tf = c()
#   for (i in 1:N){
#     Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.9-0.02*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.6-0.025*I((X[i,ttt,5])^3 > 0),0.15+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.6-0.025*I((X[i,ttt,5])^3 > 0),0.15+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     for (ttt in (M-1):(M)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
...
#   Tf = c()
#   for (i in 1:N){
#     Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.95-0.02*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.7-0.025*I((X[i,ttt,5])^3 > 0),0.05+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.95-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.7-0.025*I((X[i,ttt,5])^3 > 0),0.05+0.025*I((X[i,ttt,5])^3 <= 0),0.05,0.15,0.05))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     for (ttt in (M-1):(M)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.95-0.02*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
...
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.25,0),size=1,prob=c(0.7,0.15,0.15))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.97-0.02*I(X[i,ttt,1] + X[i,ttt,3] >0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.25,0),size=1,prob=c(0.7,0.15,0.15))
...
#   Tf = c()
#   for (i in 1:N){
#     Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.75-0.025*I((X[i,1,5])^3 > 0),0.05+0.025*I((X[i,1,5])^3 <= 0),0.05,0.025,0125))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.75-0.025*I((X[i,1,5])^3 > 0),0.05+0.025*I((X[i,1,5])^3 <= 0),0.05,0.025,0.125))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     for (ttt in (M-1):(M)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.75-0.025*I((X[i,1,5])^3 > 0),0.05+0.025*I((X[i,1,5])^3 <= 0),0.05,0.025,0.025))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     Tf[i] = sum(Tfy[i,]) + 0.5
#   }
...
#   for (i in 1:N){
#     Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.4-0.025*I((X[i,1,5])^3 > 0),0.15+0.025*I((X[i,1,5])^3 <= 0),0.2,0.1,0.15))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.4-0.025*I((X[i,1,5])^3 > 0),0.15+0.025*I((X[i,1,5])^3 <= 0),0.2,0.1,0.15))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     for (ttt in (M-1):(M)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
...
#   for (i in 1:N){
#     Tfy[i,1] = 0.5*I(d[i,1]==A[i,1])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,1,4] - log((X[i,1,6])^2) ) > 0) ) +
#       I(d[i,1]!=A[i,1])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.65-0.025*I((X[i,1,5])^3 > 0),0.05+0.025*I((X[i,1,5])^3 <= 0),0.15,0.05,0.05))
#     for (ttt in 2:(M-2)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
#         I(d[i,ttt]!=A[i,ttt])*sample(c(0.5,0.4,0.3,0.2,0.1),size=1,prob=c(0.65-0.025*I((X[i,1,5])^3 > 0),0.05+0.025*I((X[i,1,5])^3 <= 0),0.15,0.05,0.05))
#       Tfy[i,ttt] = I(Tfy[i,(ttt-1)]==0.5)*Tmp
#     }
#     for (ttt in (M-1):(M)){
#       Tmp =  0.5*I(d[i,ttt]==A[i,ttt])*rbinom(1,1,prob=0.9-0.025*I((2*X[i,ttt,4] - log((X[i,ttt,6])^2) ) > 0)) +
...
giventimefn <- function(givent,mt,N){
  ...
  if(givent>=mt[4]&givent<mt[5]){
    phat=matrix(1/3,N,4)
    beta =rep(100,26*dimco+15+4*dimco+3)
  }
  if(givent>=mt[5]){
    phat=matrix(1/3,N,5)
...
adjust_func <- function(N,Nstep,Ttime,C){
  ...
  u[,1]    = pmin(y[,1], C) 
  u[,2]    = pmin(apply(y[,1:2], 1, sum), C) -  u[,1] ; pos = 0.001
  for (j in 3:nstage){
...
crossvalidate <- function(train,Kfold,lambda){
  estsurv_value = c()
  for (kkk in 1:Kfold){
    corss_N = (1-1/Kfold)*N
