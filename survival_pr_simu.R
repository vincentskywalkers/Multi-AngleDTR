...
estsurv_sub=NULL
est.exp_Time_q = NULL
est.exp_Time_sub = NULL
est.exp_Time = NULL
est.exp_Time_true = NULL
MCR=matrix(0,Run,1)
...
print(mean(est.exp_Time_true,na.rm=T))
print(sd(est.exp_Time_true,na.rm = T))
print(mean(est.exp_Time,na.rm=T))
print(sd(est.exp_Time,na.rm = T))
print(mean(est.exp_Time_q,na.rm=T))
print(sd(est.exp_Time_q,na.rm = T))
print(mean(est.exp_Time_sub,na.rm=T))
print(sd(est.exp_Time_sub,na.rm = T))
#####################################################################################
